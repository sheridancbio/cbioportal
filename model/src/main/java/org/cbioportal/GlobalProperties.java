...
public class GlobalProperties {
    ...
    private static InputStream getResourceStream() {
        ...
        try {
            ...
            if (home != null) {
                resourceFilename = home + File.separator + GlobalProperties.propertiesFilename;
    ...
    public static String getEmailContact() {
        ...
        return (emailAddress == null) ? DEFAULT_EMAIL_CONTACT : ("<span class=\"mailme\" title=\"Contact us\">" + emailAddress + "</span>");
    }
    ...
    public static String getDarwinAuthCheckUrl() {
        return safeTrim(properties.getProperty(DARWIN_AUTH_URL));
    }

    public static String getDarwinResponseUrl() {
        return safeTrim(properties.getProperty(DARWIN_RESPONSE_URL));
    }

    public static String getDarwinAuthority() {
        return safeTrim(properties.getProperty(DARWIN_AUTHORITY));
    }

    public static String getCisUser() {
        return safeTrim(properties.getProperty(CIS_USER));
    }
