...
public class TestAnnotatedSampleSets {
	...
	public void setUp() {
        ...
        SampleList sampleList0 = new SampleList("all", 1, 2, "all gbm", SampleListCategory.OTHER);
        SampleList sampleList1 = new SampleList("all", 1, 2, "all tumors", SampleListCategory.OTHER);
        SampleList sampleList2 = new SampleList("all", 1, 2, "expression subset 1", SampleListCategory.OTHER);
    ...
    @Test
    public void test2() {
        SampleList sampleList3 = new SampleList("all", 1, 2, "all complete tumors", SampleListCategory.OTHER);
    ...
    public void test4() {
        sampleSetList = new ArrayList<SampleList>();
        SampleList sampleList0 = new SampleList("exp1", 1, 2, "exp1", SampleListCategory.OTHER);
        SampleList sampleList1 = new SampleList("exp2", 1, 2, "exp2", SampleListCategory.OTHER);
        SampleList sampleList2 = new SampleList("exp3", 1, 2, "exp3", SampleListCategory.OTHER);
        sampleSetList.add(sampleList0);
        sampleSetList.add(sampleList1);
        sampleSetList.add(sampleList2);
        AnnotatedSampleSets annotatedSampleSets = new AnnotatedSampleSets(sampleSetList);
